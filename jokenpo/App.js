...
export default function App() {
  ...
  function exibirImagem(numero){
    if(numero==0){
      return(<Image source={require('./assets/punho.png')} style={styles.img2} />)
    }
    if(numero==1){
      return(<Image source={require('./assets/pedra.png')} style={styles.img2} />)
    }
    if(numero==2){
      return(<Image source={require('./assets/papel.png')} style={styles.img2} />)
    }
    if(numero==3){
  ...
  return (
    <View style={styles.container} >
      <View style={styles.area} >
        <Image source={require('./assets/jokenpo-logo.png')} style={styles.img} />
      </View>
        ...
        <Text>
          ...
          <TouchableOpacity onPress={()=>jogo()} >  
            <View style={styles.btnArea} >
              <Image source={require('./assets/vs.png')} style={styles.img4} />
            </View>
          </TouchableOpacity>
          {exibirImagem(p2)}
        </Text>
      ...
      <View style={styles.area} >
        <Text>
          <TouchableOpacity onPress={()=>jogar(1)} >  
            <View style={styles.btnArea} >
              <Image source={require('./assets/pedra.png')} style={styles.img2} />
            </View>

          </TouchableOpacity>
          <TouchableOpacity onPress={()=>jogar(2)} >  
            <View style={styles.btnArea} >
              <Image source={require('./assets/papel.png')} style={styles.img2} />
            </View>

          </TouchableOpacity>
          <TouchableOpacity onPress={()=>jogar(3)} >  
            <View style={styles.btnArea} >
              <Image source={require('./assets/tesoura.png')} style={styles.img2} />
            </View>
          </TouchableOpacity>
        </Text>
      </View>
